...
// Crear un estudiante
const createStudent = async (nombre, apellido, email, telefono, fechaNacimiento, programaId, coordinador, ultimoCursoVisto, numeroCedula, modalidadEstudio) => {
...
const updateStudent = async (id, nombre, apellido, email, telefono, fechaNacimiento, programaId, coordinador, ultimoCursoVisto, numeroCedula, modalidadEstudio, activo) => {
  const result = await pool.query(
    `UPDATE students 
